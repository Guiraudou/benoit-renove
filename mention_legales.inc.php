	...
	<div class="col-6 text-center">
		<div class="card">
			<div class="card-body">
				...
				<div><span class="fw-bold">Adresse :</span> <?php echo POSTAL_ADDRESS; ?></div>
				<div><span class="fw-bold">SIRET :</span> <?php echo SIRET; ?></div>
				<div><span class="fw-bold">Email :</span> <a href="mailto:<?php echo EMAIL; ?>"><?php echo EMAIL; ?></a></div>
				<div><span class="fw-bold">Téléphone :</span> <a href="tel:<?php echo PHONE_NUMBER; ?>>" class="phone_number"><?php echo PHONE_NUMBER; ?></a></div>
			</div>
		</div>
	</div>
	<div class="col-6 text-center">
...
<p>L’entreprise individuelle <?php echo COMPANY_NAME; ?>, soucieuse des droits des individus, notamment au regard des traitements automatisés et dans une volonté de transparence avec ses clients, a mis en place une politique reprenant l’ensemble de ces traitements, des finalités poursuivies par ces derniers ainsi que des moyens d’actions à la disposition des individus afin qu’ils puissent au mieux exercer leurs droits.</p>
...
<p>située : <?php echo POSTAL_ADDRESS; ?></p>
<p>SIRET : <?php echo SIRET; ?></p>
<p>n° de téléphone : <a href="tel:<?php echo PHONE_NUMBER; ?>"><?php echo PHONE_NUMBER; ?></a></p>
<p>adresse email : <a href="mailto:<?php echo EMAIL; ?>"><?php echo EMAIL; ?></a></p>

<p class="subtitle">1.3 Hébergeur (ci-après « l’hébergeur ») :</p>
<p>Benoit Rénove est hébergé par OVH, dont le siège social est situé : 2 rue Kellermann — BP 80157 — 59053 ROUBAIX CEDEX 1 — France</p>
...
<p>Vos données sont collectées par l’entreprise individuelle <?php echo COMPANY_NAME; ?>.</p>
...
<p>Vous pouvez exercer ce droit en nous contactant, à l’adresse suivante : <?php echo POSTAL_ADDRESS; ?></p>
<p>Ou par email, à l’adresse : <a href="mailto:<?php echo EMAIL; ?>"><?php echo EMAIL; ?></a></p>
...
<p>Vous êtes susceptible de recevoir des offres commerciales de l’éditeur. Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : <a href="mailto:<?php echo EMAIL; ?>"><?php echo EMAIL; ?></a>.</p>
<p>Vos données sont susceptibles d’être utilisées par les partenaires de l’éditeur à des fins de prospection commerciale, si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : <a href="mailto:<?php echo EMAIL; ?>"><?php echo EMAIL; ?></a>.</p>
...
<p>Pour toute question, information sur les produits présentés sur le site, ou concernant le site lui-même, vous pouvez laisser un message à l’adresse suivante : <a href="mailto:<?php echo EMAIL; ?>"><?php echo EMAIL; ?></a>.</p>